          ...
          <div>
            ...
            <div className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+6283197188148" className="text-background/80 hover:text-background transition">+62 878-6671-4970</a>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4 flex-shrink-0" />
                <a href="mailto:noaanaturalstone@gmail.com" className="text-background/80 hover:text-background transition">noaanaturalstone@gmail.com</a>
              </div>
            </div>
          </div>
        </div>
